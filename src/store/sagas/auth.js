...
export function * authUserSaga (action) {
  ...
  let url = 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key='.concat(
    apiKey
  )
  if (!action.isSignup) {
    url = 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key='.concat(
      apiKey
    )
  }
  try {
